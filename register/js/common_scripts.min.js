...
function (d) {
    ...
    function (o) {
        ...
        o.widget("ui.button", {
            ...
            options: {
                items: ":button, :reset, :checkbox, :radio, a, :data(button)"
            },
            _create: function () {
    ...
    function (u, c) {
        ...
        u.each("branch form header step wrapper".split(" "), function () {
            ...
            options: {
                ...
                afterSelect: null,
                beforeBackward: null,
                beforeBackward1: null,

                beforeBackward2: null,
            ...
            _create: function () {
                ...
                n[0].elements ? t = n : (t = n.find("form")).length || (t = n.closest("form")), (e = n.find(s.header)).length || (e = t.find(s.header)), i.elements = {
                    ...
                    ferward: t.find(s.ferward),
                    fsrward: t.find(s.fsrward),
                    backward: t.find(s.backward),
                    backward1: t.find(s.backward1),
                    backward2: t.find(s.backward2),
                ...
                }), o.attr("id") || o.attr("id", p + "-" + ++a), i.elements.ferward.click(function (t) {
                    t.preventDefault(), i.ferward(t)
                }), o.attr("id") || o.attr("id", p + "-" + ++a), i.elements.fsrward.click(function (t) {
                    t.preventDefault(), i.fsrward(t)
                }), i.elements.backward.click(function (t) {
                    t.preventDefault(), i.backward(t)
                }),i.elements.backward1.click(function (t) {
                    t.preventDefault(), i.backward1(t)
                }),i.elements.backward2.click(function (t) {
                    t.preventDefault(), i.backward2(t)
                }), i._currentState = {
                    branchesActivated: [],
                    stepsActivated: []
            ...
            backward1: function (i, t) {
                typeof i == g && (t = i, i = c), t === c && (t = 2), this._currentState.isFirstStep || typeof t != g || this._move(-t, !0, !1, function (t, e) {
                    this._update(i, this._state(t, e))
                })
            },
            backward2: function (i, t) {
                typeof i == g && (t = i, i = c), t === c && (t = 3), this._currentState.isFirstStep || typeof t != g || this._move(-t, !0, !1, function (t, e) {
                    this._update(i, this._state(t, e))
                })
            },
            branch: function (t) {
            ...
            ferward: function (i, t, e) {
                typeof i == g && (e = t, t = i, i = c), t === c && (t = 2), this._currentState.isLastStep || typeof t != g || this._move(t, !0, e, function (t, e) {
                    this._update(i, this._state(t, e))
                })
            },
            fsrward: function (i, t, e) {
                typeof i == g && (e = t, t = i, i = c), t === c && (t = 3), this._currentState.isLastStep || typeof t != g || this._move(t, !0, e, function (t, e) {
                    this._update(i, this._state(t, e))
                })
            },
